...
func main() {
	...
	//var x_int8 int8 = -128 //can have negative and positive no, so range is -128 to 127
	...
	fmt.Println("------String-----") // String - read only slice of byte(uint8)
	// string is immutable --> once string is created it is impossible to change the contents of a string
